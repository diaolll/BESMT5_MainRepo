...
// ErrNotFound dan ErrDuplicate dipakai ulang dari user_repository.go
// (satu paket repository, sentinel error yang sama untuk semua entitas).
...
func (r *studentPostgresRepository) Update(
	...
	// owner_id TIDAK diubah lewat Update — hanya nim/name/grade/is_active.
	err := r.pool.QueryRow(ctx,
