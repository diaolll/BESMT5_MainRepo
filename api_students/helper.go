...
// Whitelist ini yang mencegah SQL-injection-style sort ketika nanti pindah ke database.
var allowedSort = map[string]bool{
	"id": true, "name": true, "grade": true, "created_at": true,
}

// batas atas limit per halaman — mencegah klien meminta seluruh data sekaligus
// dan menghabiskan memori server.
const maxLimit = 100
